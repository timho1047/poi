...
if __name__ == "__main__":
    # we can change the run_name to any model id as listed in the README.md
    config = LLMConfig(run_name="new-llama3-nyc-base")
    
    # if from_hub is True, the model will be loaded from the Hugging Face hub repo, otherwise it will be loaded from the local directory
