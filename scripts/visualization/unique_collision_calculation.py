...
USAGE:
    ...
    uv run scripts/visualization/unique_collision_calculation.py
...
def main():
    ...
    print("=" * 70)
    print(f"📊 Processing {len(models)} models from LLM Dataset/Intermediate Files/\n")
    ...
    for i, (dataset, model) in enumerate(models, 1):
        ...
        if metrics:
            ...
            print(f"   ✅ Unique SID: {metrics['unique_sid']}")
            print(f"   ✅ Collided SID buckets: {metrics['collided_sid_buckets']}\n")
